...
file_ext = str_c("threshold1_18_removeNegC",Sys.Date(), ".csv")
directory = ("./threshold1_18_removeNegC/")


### load in data 

dat0 <- read_csv("./nSolver_outputs/background_threshold/threshold_18_removeNegC.csv")
dat0 %>% head(10)
dat0 %>% tail(10)
dat0 %>% colnames()
...
candidates <- read_csv(str_c(directory, "NormFinder_OrderedResults_threshold1_18_removeNegC2023-02-24.csv")) %>% 
